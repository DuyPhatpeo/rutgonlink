...
<body class="font-inter min-h-screen text-slate-900 bg-blue-50" data-auth="{{ Auth::check() ? '1' : '0' }}">
    ...
    <nav class="max-w-6xl mx-auto px-4 md:px-6 py-4 flex justify-between items-center transition-all">
        <div class="text-2xl md:text-3xl font-black text-brand-blue tracking-tighter select-none cursor-pointer" onclick="window.location.assign('/')">LinkSnap</div>
