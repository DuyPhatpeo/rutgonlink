                        ...
                        <tr class="hover:bg-slate-50/30 transition-colors group">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center justify-end gap-2">
                                    <button onclick="LinkManager.toggleStatus('{{ $link->short_code }}', this)" class="p-2.5 rounded-xl transition-all shadow-sm active:scale-90 mr-3 {{ $link->is_active ? 'bg-emerald-50 text-emerald-500 hover:bg-emerald-500 hover:text-white' : 'bg-rose-50 text-rose-500 hover:bg-rose-500 hover:text-white' }}" title="{{ $link->is_active ? 'Đang hoạt động (Nhấn để khóa)' : 'Bị khóa (Nhấn để bật)' }}">
                                        @if($link->is_active)
                                    ...
                                    <a href="{{ route('links.show', $link->short_code) }}" class="p-2.5 rounded-xl bg-slate-100 text-slate-500 hover:bg-brand-blue hover:text-white transition-all shadow-sm active:scale-90" title="Thống kê">
                                    ...
                                    <button onclick="LinkManager.deleteLink('{{ $link->short_code }}')" class="p-2.5 rounded-xl bg-rose-50 text-rose-500 hover:bg-rose-500 hover:text-white transition-all shadow-sm active:scale-90" title="Xoá">
